...
LOGS = logging.getLogger("اعداد بلاكثون")
...
async def saves():
    ...
    try:
        ...
        await jmub(JoinChannelRequest("@BBPP8"))
        ...
        try:
            if BOTLOG:
                await jmub.tgbot.send_file(
                    BOTLOG_CHATID,
                    "",
                    caption="**شكرا لتنصيبك سورس بلاكثون**\n • هنا بعض الملاحظات التي يجب ان تعرفها عن استخدامك لسورس بلاكثون.",
        ...
        try:
            if BOTLOG:
                await jmub.tgbot.send_message(
                    BOTLOG_CHATID,
                    "**لقد تم بنجاح تنصيب سورس بلاكثون **\n➖➖➖➖➖➖➖➖➖➖\n**السورس**: @gibthon7\n**المطور**: @zeko124\n➖➖➖➖➖➖➖➖➖➖\n**مجموعة الدعم**: @gibthon9\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
...
STRINGS = {
    1: """🎇 **- شكراً لتنصيبك سورس بلاكثون **
•• من الاسفل بعض الخيارات التي ستساعدك في بلاكثون.""",
    2: """🎉** حول بلاكثون**
🧿 بلاكثون هو يوزربوت في مكتبة التيليثون تم صنعه بأستخدام البايثون. يحتوي على اكثر من 100 أمر تساعدك في التليجرام و جبثون هو افضل سورس من ناحية الامان.
